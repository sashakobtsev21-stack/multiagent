...
- Пн 29.06 — [x] ⭐ [Статья] How to Get Around Albania: Buses, Furgons & Ferries · `how to get around albania` / `albania furgon buses` · /transport/how-to-get-around-albania/ · transport · фото 6 · 💰 аренда авто/трансфер · кластер transport-routes [head] · перелинк: ← car rental, → tirana-airport-transfers, → tirana-to-saranda, → is-expensive — ОПУБЛИКОВАНО 2026-06-29 (en, qa=GO) (slug: how-to-get-around-albania)
- Пн 29.06 — [x] [Статья] Tirana Airport to City Centre: Transfers & Options · `tirana airport to city centre` · /transport/tirana-airport-transfers/ · transport · фото 5 · 💰 трансфер (kiwitaxi)/аренда авто · кластер transport-routes [head] · перелинк: ← Tirana things to do, ← car rental, → how-to-get-around, → tirana-to-saranda — ОПУБЛИКОВАНО 2026-06-29 (en, qa=GO) (slug: tirana-airport-transfers)
- Пн 29.06 — [x] [Статья] Tirana to Saranda: Bus, Car, Transfer & Travel Times · `tirana to saranda` · /transport/tirana-to-saranda/ · transport · фото 5 · 💰 trip-carhire/kiwitaxi · кластер transport-routes [head] · перелинк: ← saranda guide, ← is-expensive, → how-to-get-around, → tirana-airport-transfers — ОПУБЛИКОВАНО 2026-06-29 (en, qa=GO) (slug: tirana-to-saranda)
- Пн 29.06 — ✅ Замер GA/GSC — выполнен 28.06 (baseline)
- Вт 30.06 — [x] [Статья] Saranda to Corfu Ferry: Timetable, Tickets & How to Book · `saranda to corfu ferry` · /transport/saranda-corfu-ferry/ · transport · фото 6 · 💰 trip-tours (ferry) · кластер transport-routes [head] · перелинк: ← tirana-to-saranda, → how-to-get-around, → tirana-airport-transfers — ОПУБЛИКОВАНО 2026-06-30 (en, qa=GO) (slug: saranda-corfu-ferry)
- Вт 30.06 — [x] [Статья] How to Get to Albania: Flights, Airports, Ferries & Buses · `how to get to albania` · /transport/how-to-get-to-albania/ · transport · фото 5 · 💰 trip-transfers · кластер transport-routes [head] · перелинк: ← how-to-get-around, → tirana-airport-transfers, → saranda-corfu-ferry — ОПУБЛИКОВАНО 2026-06-30 (en, qa=GO) (slug: how-to-get-to-albania)
- Вт 30.06 — [x] [Статья] Tirana to Berat: Bus, Furgon, Car & Day Trip Options · `tirana to berat` · /transport/tirana-to-berat/ · transport · фото 5 · 💰 trip-carhire/trip-transfers · кластер transport-routes [mid] · перелинк: ← berat-albania-guide, → how-to-get-around, → how-to-get-to-albania, → how-to-rent-a-car — ОПУБЛИКОВАНО 2026-06-30 (en, qa=GO) (slug: tirana-to-berat)
